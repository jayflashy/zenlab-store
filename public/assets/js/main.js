(function ($) {
    ...
    $(document).ready(function () {
        ...
        const currentTheme = localStorage.getItem("zenlab-theme");
        ...
        function switchTheme(e) {
            if (e.target.checked) {
                ...
                localStorage.setItem("zenlab-theme", "dark");
            } else {
                document.documentElement.setAttribute("data-theme", "light");
                localStorage.setItem("zenlab-theme", "light");
            }
        }
        ...
        const statisticsCounter = document.querySelectorAll(
            ".statistics__amount"
        );
        ...
        if (socialShareBtn.length > 0) {
            ...
            let rightDistance =
                $(window).width() -
                (leftDistance + socialShareBtn.outerWidth());
