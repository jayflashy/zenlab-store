    ...
    <div class="invoice">
        <div class="row row-cols-auto justify-content-between align-items-center g-3 flex-nowrap">
            ...
            <div class="col text-end">
                ...
                <p class="mb-0"><span class="text-muted">ID:</span> #{{ $order->code }}</p>
            </div>
        </div>
        <div class="mt-4 pt-4 border-top">
            <div class="row row-cols-auto justify-content-between g-3">
                <div class="col">
                    <h6 class="text-uppercase">Billed to:</h6>
                    <p class="text-muted fw-light mb-0">{{ $order->name }}</p>
                ...
                <div class="col">
                    @if ($order->payment_status == 'completed')
                        <svg xmlns="http://www.w3.org/2000/svg" width="140px" height="140px" viewBox="0.00 0.00 980.00 940.00">
                            <path fill="#1363DF" d="
                                M 821.66 554.94
                    ...
                    @elseif ($order->payment_status == 'pending')
                        <svg xmlns="http://www.w3.org/2000/svg" width="140px" height="140px" viewBox="0.00 0.00 980.00 940.00">
                            <!-- Main hexagon shape (same as completed but with orange color) -->
                            <path fill="#FF9A00" d="
                            M 821.66 554.94
                            Q 518.37 692.51 209.95 832.39
                            Q 207.79 833.37 204.19 833.80
                            ...
                            <!-- Clock icon design for pending -->
                            <path fill="#FF9A00" d="
                            M 490 330
                            A 140 140 0 1 1 490 610
                            A 140 140 0 1 1 490 330
                            Z
                            M 490 365
                            A 105 105 0 1 0 490 575
                            A 105 105 0 1 0 490 365
                            Z"></path>
                    ...
                    @elseif ($order->payment_status == 'failed')
                        <svg xmlns="http://www.w3.org/2000/svg" width="140px" height="140px" viewBox="0.00 0.00 980.00 940.00">
                            <!-- Main hexagon shape (same as completed but with red color) -->
                            <path fill="#E63946" d="
                            M 821.66 554.94
                            Q 518.37 692.51 209.95 832.39
                            Q 207.79 833.37 204.19 833.80
                            ...
                            M 380 380
                            L 600 600
                            A 15 15 0 0 1 600 621
                            A 15 15 0 0 1 579 621
                            L 359 401
                            A 15 15 0 0 1 359 380
                            A 15 15 0 0 1 380 380
                            Z"></path>

                            <path fill="#E63946" d="
                            M 600 380
                            L 380 600
                            A 15 15 0 0 1 359 600
                            A 15 15 0 0 1 359 579
                            L 579 359
                            A 15 15 0 0 1 600 359
                            A 15 15 0 0 1 600 380
                            Z"></path>
                        </svg>
                    @endif
                </div>
        ...
        @endphp
            ...
            <p class="text-muted">
                * This transaction was processed by {{ $paymentMethodLabel }}
            </p>
        </div>
