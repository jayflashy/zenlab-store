<div class="container-fluid py-4">
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <div class="input-group">
                        ...
                        <input wire:model.live.debounce.300ms="searchTerm" type="search" class="form-control" placeholder="Search categories">
                    </div>
                </div>
                <div class="col-md-3">
            ...
            <form wire:submit="save">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" wire:model="sortOrder" id="order" class="form-control @error('sortOrder') is-invalid @enderror">
                        @error('sortOrder') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>

                    <div class="col-md-6">
                        <label for="metaTitle" class="form-label">Meta Title</label>
                        <input type="text" wire:model="metaTitle" id="metaTitle" class="form-control @error('metaTitle') is-invalid @enderror">
                        @error('metaTitle') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>

                    <div class="col-md-6">
                        <label for="metaDescription" class="form-label">Meta Description</label>
                        <input type="text" wire:model="metaDescription" id="metaDescription" class="form-control @error('metaDescription') is-invalid @enderror">
    ...
    <div class="modal fade show" style="display: block; background-color: rgba(0,0,0,0.5);" tabindex="-1" aria-labelledby="deleteModalLabel" aria-modal="true">
