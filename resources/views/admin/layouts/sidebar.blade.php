    ...
    <div class="dashboard-sidebar__inner">
        ...
        <ul class="sidebar-list">
            ...
            <li class="sidebar-list__item side-hsb">
                ...
                <ul class="side-submenu">
                    <li class="nav-submenu__item">
                        <a href="{{route('admin.settings.index')}}" wire:navigate class="nav-submenu__link">General </a>
                    </li>
                    <li class="nav-submenu__item">
                        <a href="{{ route('admin.dashboard') }}" wire:navigate class="nav-submenu__link">Listing</a>
                    </li>
                    <li class="nav-submenu__item">
                        <a href="{{route('admin.settings.index')}}" wire:navigate class="nav-submenu__link">others</a>
                    </li>
                </ul>
            </li>
