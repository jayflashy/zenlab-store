<footer class="footer-section ">
    <img src="public/assets/images/shapes/pattern.png" alt="" class="bg-pattern">
    <img src="public/assets/images/shapes/element1.png" alt="" class="element one">
    <img src="public/assets/images/shapes/element2.png" alt="" class="element two">
    <img src="public/assets/images/gradients/footer-gradient.png" alt="" class="bg--gradient">
            ...
            <div class="col-xl-3 col-sm-6">
                <div class="footer-widget">
                    <div class="footer-widget__logo">
                        <a href="index.html"> <img src="public/assets/images/logo/white-logo.png" alt=""></a>
                    </div>
